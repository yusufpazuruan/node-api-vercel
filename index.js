...
app.post("/data", (req, res) => {
  ...
  const query = "INSERT INTO data (nama, usia) VALUES (?, ?)";
  connection.query(query, [nama, usia], (error, results) => {
    if (error) {
...
app.post("/santri/:id/isasi", (req, res) => {
  ...
  const query =
    "INSERT INTO isagis (santri_id, status, keterangan, sampai_tgl, pejuang, ttd) VALUES (?, ?, ?, ?, ?, ?)";
  connection.query(
    query,
